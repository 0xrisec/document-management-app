...
describe('QnaInterfaceComponent', () => {
  ...
  // it('should initialize and connect to the server on ngOnInit', () => {
  //   const connectServerSpy = spyOn<any>(component, 'connectServer').and.callThrough();
  //   const initializeDocumentsSpy = spyOn<any>(component, 'initializeDocuments').and.callThrough();

  //   component.ngOnInit();

  //   expect(connectServerSpy).toHaveBeenCalled();
  //   expect(initializeDocumentsSpy).toHaveBeenCalledWith('test-file-url');
